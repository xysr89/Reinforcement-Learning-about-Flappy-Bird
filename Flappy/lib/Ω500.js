		...
		checkCollision: function (entity, entities, cbName) {
			...
			for (i = 0; i < len; i++) {
				...
				/*if (a !== b &&
						ax + a.w >= bx &&
					    ax <= bx + b.w ) {
					document.getElementById("demo").innerHTML += "<br>" + a.x+"&nbsp&nbsp&nbsp"+a.y+"&nbsp&nbsp&nbsp"+
		            b.h +"&nbsp&nbsp&nbsp"+ b.w+"&nbsp&nbsp&nbsp"+ b.x+"&nbsp&nbsp&nbsp"+ b.y;
					document.getElementById("demo").innerHTML += "<br>" + xx1 + "&nbsp&nbsp&nbsp" + yy1;
				}*/
				if (a !== b &&
					ax + a.w >= bx &&
				    ax <= bx + b.w &&
					...
					/*document.getElementById("demo").innerHTML += "<br> HITTTTTT" + a.x+"&nbsp&nbsp&nbsp"+a.y+"&nbsp&nbsp&nbsp"+
		            b.h +"&nbsp&nbsp&nbsp"+ b.w+"&nbsp&nbsp&nbsp"+ b.x+"&nbsp&nbsp&nbsp"+ b.y;*/
					
					//document.getElementById("demo").innerHTML += "<br> HITTTTTTT" + xx1 + "&nbsp&nbsp&nbsp" + yy1;
