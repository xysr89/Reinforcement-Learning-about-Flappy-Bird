(function (Ω) {
    ...
    var MainScreen = Ω.Screen.extend({
        ...
        init: function () {
			...
			/*var q_array = document.getElementById("myTextarea").value;
			
			//console.log(q_array[0]);
			
			var lines = q_array.split('\n');
            for(var line = 0; line < lines.length; line++){
              
              var words = lines[line].split("$$");
              //var row = parseInt(words[0]);
              // var col = parseInt(words[1]);
              //console.log(typeof row);
              // var val_fly = words[3];
              // var val_stay = words[5];
              this.Q[parseInt(words[0])][parseInt(words[1])]["fly"] = words[3];
              this.Q[parseInt(words[0])][parseInt(words[1])]["stay"] = words[5];
            }*/
        ...
        tick: function () {
            ...
            switch (this.state.get()) {
                ...
                case "RUNNING":
                	...
                	if(this.never_started_before && document.getElementById("myTextarea").value.length>0) {
                		var q_array = document.getElementById("myTextarea").value;
                        ...
                        this.never_started_before = false;
                	}
